...
precip_2011 <- read_csv("./data/precip_2011.csv", col_names = TRUE) %>% 
  mutate(year = 2011)
precip_2012 <- read_csv("./data/precip_2012.csv", col_names = TRUE) %>% 
  mutate(year = 2012)
precip_2013 <- read_csv("./data/precip_2013.csv", col_names = TRUE) %>% 
  mutate(year = 2013)
precip_2014 <- read_csv("./data/precip_2014.csv", col_names = TRUE) %>% 
  mutate(year = 2014)
precip_2015 <- read_csv("./data/precip_2015.csv", col_names = TRUE) %>% 
  mutate(year = 2015)
precip_2016 <- read_csv("./data/precip_2016.csv", col_names = TRUE) %>% 
  mutate(year = 2016)
precip_2017 <- read_csv("./data/precip_2017.csv", col_names = TRUE) %>% 
  mutate(year = 2017)
precip_2018 <- read_csv("./data/precip_2018.csv", col_names = TRUE) %>% 
  mutate(year = 2018)
